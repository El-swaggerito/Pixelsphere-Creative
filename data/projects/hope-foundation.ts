export const hopeFoundationProject = {
  ...
  featuredImage: "/images/hope.png",
  images: {
    showcase1: "/images/hope-1.png",
    showcase2: "/images/hope-2.png",
    showcase3: "/images/hope-3.png",
    showcase4: "/images/hope-4.png",
  },
  brandingLink: "/portfolio/hope-foundation/branding",
...
Our design system prioritizes readability and accessibility, ensuring that all users, including those with disabilities, can easily navigate and interact with the content. Every visual element was chosen to reinforce the foundation's commitment to inclusivity and human dignity.`,
  userStatement: `"As someone seeking help from charitable organizations, I often struggle to find clear information about what services are available and how to access them. I needed a platform that not only offers help but also treats us with dignity and respect."

This feedback shaped our entire approach to the website design, ensuring that accessibility wasn't an afterthought but a core principle guiding every design decision. We conducted extensive user testing with community members to ensure the platform truly serves its intended audience.`,
  problemList: [
  ...
  servicesProvided: ["Web Development", "Branding", "SEO Optimization", "Accessibility Consulting"],
}
