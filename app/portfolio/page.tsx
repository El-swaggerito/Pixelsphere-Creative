  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-white">
        ...
        <section className="relative min-h-[50vh] xxxxs:min-h-[45vh] xxxs:min-h-[65vh] xxs:min-h-[55vh] xs:min-h-[60vh] sm:min-h-[80vh] md:min-h-[70vh] lg:min-h-screen flex flex-col overflow-hidden">
          <HeroBackground className="!min-h-[50vh] xxxxs:!min-h-[45vh] xxxs:!min-h-[65vh] xxs:!min-h-[55vh] xs:!min-h-[60vh] sm:!min-h-[80vh] md:!min-h-[70vh] lg:!min-h-screen">
