          ...
          <section className="relative min-h-[50vh] xxxxs:min-h-[45vh] xxxs:min-h-[50vh] xxs:min-h-[55vh] xs:min-h-[60vh] sm:min-h-[100svh] flex flex-col overflow-hidden">
            <HeroBackground className="xl:-mt-16 !min-h-[50vh] xxxxs:!min-h-[45vh] xxxs:!min-h-[50vh] xxs:!min-h-[55vh] xs:!min-h-[60vh] sm:!min-h-screen">
              ...
              <div className="relative z-40 flex flex-col items-center justify-center text-center px-2 xxxxs:px-3 xxxs:px-4 xxs:px-6 sm:px-8 lg:px-12 xl:px-16 pt-16 xxxxs:pt-18 xxxs:pt-20 xxs:pt-24 xs:pt-28 sm:pt-32 lg:pt-36 xl:pt-40 pb-8 xxxxs:pb-10 xxxs:pb-12 xxs:pb-16 xs:pb-20 sm:pb-24 lg:pb-28 xl:pb-32">
                ...
                <p className="text-xs xxxxs:text-sm xxxs:text-base xxs:text-lg xs:text-xl sm:text-xl lg:text-2xl text-white/90 mb-6 xxxxs:mb-8 xxxs:mb-10 xxs:mb-12 sm:mb-16 max-w-xs xxxxs:max-w-sm xxxs:max-w-md xxs:max-w-lg sm:max-w-2xl lg:max-w-4xl leading-relaxed">
